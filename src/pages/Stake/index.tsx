...
const Stake = () => {
  const Button = styled.div<any>`
    background-image: linear-gradient(to right, #2ecc71 0%, #16a085  51%, #c8f7c5  100%);
    margin: 0px;
    margin-top: 10px;
    padding: 15px 45px;
    text-align: center;
    ...
    <>
      ...
      <AppBody>
        <Wrapper id="stake-page">
          <PageHeader
            title={TranslateString(8, 'CactAssStake')}
            description={TranslateString(1192, 'Stake your CactAss to get a rewards')}
          />
          <CardBody>
            <AutoColumn gap="lg">
              <CurrencyInputPanel
